...
<body>
      ...
      <div class="row" style="width:100%; padding-left:1% ">
        <div class="col-2 bgLeft" style="height:30vh; "><br>
        <div class="dropdown">
        ...
        <div class="modal-header " style=" width:25%; margin-left:8%;>
          <div id="show_index" ><br>
    <form action="save1.php" method="post" enctype = "multipart/form-data"><h1>นำเข้าเอกสารเข้า</h1>
    หัวข้อเอกสาร <input type="text">
        </*input type="file" name="myfile" required accept="image/*">
        <input type="file" name="upload" required accept="application/pdf,application/vnd.ms-excel" />
